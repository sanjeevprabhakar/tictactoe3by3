...
public class TicTacToe extends javax.swing.JFrame {
    ...
    public TicTacToe() {
        ...
        grid = new JButton[3][3]; // array to hold button objects
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // action when users clicks any button
        // same code for all 9 Buttons
    ...
    void checkForTheWin() {
        ...
        if (moves.contains("XXX")) {
            JOptionPane.showMessageDialog(this, "The winner is: X");
        }
        if (moves.contains("OOO")) {
            JOptionPane.showMessageDialog(this, "The winner is: O");
        }
    }
